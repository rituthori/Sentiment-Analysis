...
def negated(input_words, include_nt=True):
    ...
    for word in neg_words:
        if word in input_words:
            return True
    if include_nt: # shouldn't, couldn't; all the n't words
...
class SentiText(object):
    ...
    def __init__(self, text):
        ...
        self.is_cap_diff = allcap_differential(self.words_and_emoticons) #Check whether some words are CAPS
...
def visualize(cmpd_score):
    cmpd_pos,cmpd_neg, cmpd_neu =0,0,0 
    for i in cmpd_score:
        if i>0:
            cmpd_pos+=1
        elif i<0:
            ...
            cmpd_neu+=1
    print("Number of postive Emotions detected:- "+str(cmpd_pos))
    print("Number of negative Emotions detected:- "+str(cmpd_neg))
    print("Number of neutral Emotions detected:- "+str(cmpd_neu))
    data = [cmpd_pos,cmpd_neg,cmpd_neu]
    label = ["Postive: "+str(cmpd_pos),"Negative- "+str(cmpd_neg),"Neutral- "+str(cmpd_neu)]
...
if __name__ == '__main__':
    ...
    for sentence in sentences:
        ...
        cmpd_score.append(vs["compound"])
        print("{:-<65} {}".format(sentence, str(vs))+"\n")
        fp.write("{:-<65} {}".format(sentence, str(vs))+"\n")
    print("----------------------------------------------------")
    fp.close() 
    #print(cmpd_score)
    visualize(cmpd_score)
    print("\n\n Done!")
